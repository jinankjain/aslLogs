...
echo -e "Running test for Part 2 of Milestone 2:"
...
do
    ...
    do
        ...
        do
            if [ $j -eq 0 ]; then
                ssh $middleware tmux send -t foo "java" SPACE "-jar" SPACE "dist/middleware-jjain.jar" SPACE "-l" SPACE "10.0.0.10" SPACE "-p" SPACE "8000" SPACE "-t" SPACE 30 SPACE "-r" SPACE "1" SPACE "-m" SPACE ${server_list} "\>" SPACE "../../part2/repition"$g"/middlwareReplication1Server"$i".log" ENTER;
                pssh -h pssh-hosts -l jjain tmux send -t foo "./memaslap" SPACE "-s" SPACE "10.0.0.10:8000" SPACE "-T" SPACE "200" SPACE "-c" SPACE "200" SPACE "-o1" SPACE "-S" SPACE "1s" SPACE "-t" SPACE "60s" SPACE "-F" SPACE "new.cfg" SPACE "\>" SPACE "../../part2/repition"$g"/memslapReplication1Server"$i".log" ENTER ;
                sleep 200s;
